...
var LabModule = (function () {
  ...
  function renderQuestion() {
    ...
    /* 参考路径 */
    h += '<details class="acc answer" style="margin-top:14px"><summary>📖 显示参考答案：分析路径（' + cur.queries.length + ' 步 · 含可运行 SQL 与关键发现）</summary><div class="accbody">';
    ...
    h += '<details class="acc answer"><summary>📖 显示参考答案：参考结论</summary><div class="accbody" style="border-left:3px solid var(--em);padding-left:12px">' + esc(cur.conclusion) + '</div></details>';
